  ...
  return (
    <div className="prose prose-slate mx-auto dark:prose-invert prose-ul:list-disc prose-ul:ml-4">
      ...
      <Typography.P>
        ...
        не е комерсиален (без реклами, платени услуги или финансови трансакции).
      </Typography.P>
      <br />
      ...
      <ul className="list-disc list-inside ml-4">
        ...
        <li>Cookie идентификатори (вижте Политика за бисквитки);</li>
        <li>
      ...
      <Typography.P>
        ...
        <br />
        Уебсайт:{" "}
        <a href="https://www.cpdp.bg" target="_blank" rel="noreferrer">
          https://www.cpdp.bg
        </a>
        <br />
      ...
      <Typography.P>
        ...
        нашата <strong>Политика за бисквитки</strong>.
      </Typography.P>
      <br />
